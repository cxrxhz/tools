...
function readSettingsFile(settingsPath) {
    ...
    try {
        ...
        return {
            serverUrl: typeof settings['ntfyBridge.serverUrl'] === 'string'
                ? settings['ntfyBridge.serverUrl']
                : undefined,
            inputTopic: typeof settings['ntfyBridge.inputTopic'] === 'string'
                ? settings['ntfyBridge.inputTopic']
                : undefined,
            outputTopic: typeof settings['ntfyBridge.outputTopic'] === 'string'
                ? settings['ntfyBridge.outputTopic']
                : undefined
        };
    } catch (err) {
